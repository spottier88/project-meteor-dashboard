...
export function PermissionsProvider({ children }: { children: React.ReactNode }) {
  ...
  if (isError) {
    console.error("[PermissionsProvider] Erreur lors du chargement des permissions");
    return (
      <div className="flex items-center justify-center min-h-screen">
        <p className="text-sm text-destructive">Erreur lors du chargement des permissions. Veuillez rafraîchir la page.</p>
      </div>
    );
  }
