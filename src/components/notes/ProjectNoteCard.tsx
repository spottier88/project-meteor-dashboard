 ...
 * Note : La confirmation de suppression est gérée par le composant parent (ProjectNotesList)
 * pour éviter les problèmes de pointer-events lock avec Radix UI.
 */
...
interface ProjectNoteCardProps {
  ...
  onRequestDelete: (note: ProjectNote) => void;
          ...
          {hasActions && (
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end">
                {canEdit && (
                  <>
                    <DropdownMenuItem onSelect={() => onTogglePin(note.id, note.is_pinned)}>
                      {note.is_pinned ? (
                        <>
