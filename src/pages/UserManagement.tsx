...
const getRoleLabel = (role: UserRole): string => {
  switch (role) {
    ...
    case "time_tracker": return "Suivi activités";
    case "portfolio_manager": return "Gestionnaire de portefeuille";
    case "quality_manager": return "Responsable Qualité";
    default: return role;
  }
};
  ...
  if (sortKey && sortDirection) {
    filteredUsers = [...filteredUsers].sort((a, b) => {
      ...
      switch (sortKey) {
        ...
        case "last_name": valueA = a.last_name || ""; valueB = b.last_name || ""; break;
        case "roles": valueA = a.roles.join(","); valueB = b.roles.join(","); break;
        case "lastActivity":
    ...
    <div className="container mx-auto py-8 px-4">
      ...
      <Tabs defaultValue="users">
        <TabsList>
          ...
          <TabsTrigger value="permissions">Revue des droits</TabsTrigger>
        </TabsList>
              ...
              <Table>
                <TableHeader>
                  <TableRow>
                    ...
                    <SortableHeader label="Prénom" sortKey="first_name" currentSort={sortKey} currentDirection={sortDirection} onSort={handleSort} />
                    <SortableHeader label="Nom" sortKey="last_name" currentSort={sortKey} currentDirection={sortDirection} onSort={handleSort} />
                    <SortableHeader label="Rôles" sortKey="roles" currentSort={sortKey} currentDirection={sortDirection} onSort={handleSort} />
                    <SortableHeader label="Dernière activité" sortKey="lastActivity" currentSort={sortKey} currentDirection={sortDirection} onSort={handleSort} />
